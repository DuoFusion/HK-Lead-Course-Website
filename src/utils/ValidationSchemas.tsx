...
export const LeadFormSchema = Yup.object({
  fullName: fieldSchema("string", "full Name"),
  email: fieldSchema("string", { required: false }),
  phone: fieldSchema("string", "phone"),
  city: fieldSchema("string", { required: false }),
  interestId: fieldSchema("string", { required: false }),
  preferredLearningMode: fieldSchema("string", { required: false }),
  background: fieldSchema("string", { required: false }),
  itKnowledgeLevel: fieldSchema("string", { required: false }),
  additionalMessage: fieldSchema("string", { required: false }),
});
...
export const WorkshopRegisterSchema = Yup.object({
  ...
  paymentMethod: fieldSchema("string", "Payment Method"),
});
