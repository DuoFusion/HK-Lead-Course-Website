          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="listing_block" data-aos="fade-up" data-aos-duration={1500}>
                <Link to={ROUTES.WORKSHOP.WORKSHOP_DETAIL} className="img">
                  <img src={`${ImagePath}/blog1.png`} alt="image" />
                </Link>
                <div className="blog_text">
                  <span className="tag">Mobile app</span>
                  <h2>
                    <Link to={ROUTES.WORKSHOP.WORKSHOP_DETAIL}>Effective ways to monetize mobile apps for better perfomance</Link>
                  </h2>
                  <Link to={ROUTES.WORKSHOP.WORKSHOP_DETAIL}>
